...
SECRET_KEY = 'django-insecure-%eiiumdelud)9wwina_um(0$5^5ri)bu3ra8fl#$6^#3c00ybm'
...
ASGI_APPLICATIONS = 'project.asgi.application'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.my_context_processors',
            ],
        },
    },
]
